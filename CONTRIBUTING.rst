...
django-manolo could always use more documentation, whether as part of the 
official django-manolo docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
2. Clone your fork locally::
    ...
    $ git clone git@github.com:your_name_here/django-manolo.git
...
3. The pull request should work for Python 2.6, 2.7, and 3.3, and for PyPy. Check 
   https://travis-ci.org/aniversarioperu/django-manolo/pull_requests
