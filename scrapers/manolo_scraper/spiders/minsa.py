    ...
    def parse(self, response):
        ...
        for row in rows:
            ...
            if len(data) > 9:
                ...
                loader.add_value('institution', 'minsa')
                loader.add_value('date', date)

                loader.add_xpath('full_name', './td[3]/text()')
                loader.add_xpath('id_document', './td[4]/text()')
                loader.add_xpath('id_number', './td[5]/text()')
                loader.add_xpath('entity', './td[6]/text()')
                loader.add_xpath('reason', './td[7]/text()')
                loader.add_xpath('host_name', './td[8]/text()')
                loader.add_xpath('office', './td[9]/text()')
                loader.add_xpath('host_title', './td[10]/text()')
