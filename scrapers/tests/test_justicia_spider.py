...
class TestJusticiaSpider(unittest.TestCase):
    ...
    def test_parse_item(self):
        ...
        self.assertEqual(
            item.get('reason'), u'CONSULTA DE EXPEDIENTE DEL REGISTRO UNICO DE VICTIMAS'
        )
        ...
        self.assertEqual(
            item.get('location'),
            u'CONSEJO DE REPARACIONES - SECRETARIA TECNICA, NEISER LLACZA ARCE 158, MIRAFLORES'  # noqa
        )
